package foo.hk.cn.secutitydemo.security.config;

import java.util.List;

import foo.hk.cn.secutitydemo.security.UserAuthenticationProvider;
import foo.hk.cn.secutitydemo.security.handle.*;
